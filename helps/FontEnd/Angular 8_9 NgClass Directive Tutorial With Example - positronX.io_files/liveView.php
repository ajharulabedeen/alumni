...
var SekindoClientDetections_URL = function (config) {
	...
	this._checkStartOverDebug = function(pageUrl)
	{
		...
		debugId = pageUrl.match(/(\?|&)debugPlayerSession\=([^&]*)/);
		if (debugId)
		{
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]&cbuster=1582534868',
					origQString: 's=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]',
					x: 700,
					y: 400,
					isSlider: false,
					isOutstream: false,
					...
					float: {enabled: true,
						...
						direction: 'br', verticalOffset: 115,
						horizontalOffset: 1, isCloseBtn: 1},
					isAPI: false,
					debug: 0,
					ci: {"extra":{"osVersionMinor":0,"schemaVer":11,"os":"Windows","osVersionMajor":10,"deviceManufacturer":"","browser":"Chrome","browserVersionMajor":"79","deviceCodeName":"","deviceType":"desktop","deviceModel":"","osVersion":"10.0","browserType":"browser","browserVersion":"79.0.3945.130","browserVersionMinor":"0"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop"},
					geo: 'XX',
					dmaCode: 0,
					dynamicSetup: [],
					uuid: '5e5390d4a59b1',
